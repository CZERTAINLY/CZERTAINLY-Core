 ...
 *
 * <p>
 * Implement this interface to handle fire-and-forget style messages where any instance can process the message. The
 * handler is registered with a specific messageType pattern, and when a message arrives with a matching messageType, it
 * will be dispatched to this handler instead of using correlation-based routing.
 * </p>
 *
 * <p>
 * Use cases:
 ...
 *
 * <p>
 * Pattern matching follows RabbitMQ topic exchange semantics. Segments are separated by '.' (dot):
 * </p>
 * <ul>
 * <li>Exact match: "health.check" matches only "health.check"</li>
 * <li>Single-segment wildcard '*': "GET.v1.certificates.*" matches "GET.v1.certificates.123" but NOT
 * "GET.v1.certificates" or "GET.v1.certificates.123.details"</li>
...
public interface MessageTypeResponseHandler {
    ...
    /**
     * Get the message type pattern this handler processes. Can be an exact match or a pattern with '*' and '#'
     * wildcards.
     *
