...
/**
 * Converts ConnectorDto authentication information to proxy message format. Maps ILM auth types and attributes to the
 * proxy's expected ConnectorAuth structure.
 */
@Slf4j
@Component
...
public class ConnectorAuthConverter {
     ...
     */
    public ConnectorAuth convert(ApiClientConnectorInfo connector) {
        ...
        if (authType == null) {
            ...
            return ConnectorAuth.builder().type("NONE").attributes(Map.of()).build();
        }

        List<ResponseAttribute> authAttributes = connector.getAuthAttributes();

        return switch (authType) {
            case NONE -> ConnectorAuth.builder().type("NONE").attributes(Map.of()).build();
    ...
    private ConnectorAuth convertBasicAuth(List<ResponseAttribute> authAttributes) {
        BaseAttributeContentV2<String> username = AttributeDefinitionUtils
                .getAttributeContent(BaseApiClient.ATTRIBUTE_USERNAME, authAttributes, true);
        SecretAttributeContentV2 password = AttributeDefinitionUtils
                .getAttributeContent(BaseApiClient.ATTRIBUTE_PASSWORD, authAttributes, true);
        ...
        log
                .debug("Converted BASIC auth with username: {}",
                        username != null && username.getData() != null ? "present" : "absent");

        return ConnectorAuth.builder().type("BASIC").attributes(attributes).build();
    }
    ...
    private ConnectorAuth convertApiKeyAuth(List<ResponseAttribute> authAttributes) {
        BaseAttributeContentV2<String> apiKeyHeader = AttributeDefinitionUtils
                .getAttributeContent(BaseApiClient.ATTRIBUTE_API_KEY_HEADER, authAttributes, true);
        SecretAttributeContentV2 apiKey = AttributeDefinitionUtils
                .getAttributeContent(BaseApiClient.ATTRIBUTE_API_KEY, authAttributes, true);
        ...
        return ConnectorAuth.builder().type("API_KEY").attributes(attributes).build();
    }

    /**
     * Convert CERTIFICATE (mTLS) authentication. The proxy expects base64-encoded keystore and truststore in PKCS12
     * format.
     */
    private ConnectorAuth convertCertificateAuth(List<ResponseAttribute> authAttributes) {
        ...
        FileAttributeContentV2 keyStoreData = AttributeDefinitionUtils
                .getAttributeContent(BaseApiClient.ATTRIBUTE_KEYSTORE, authAttributes, true);
        ...
        SecretAttributeContentV2 keyStorePassword = AttributeDefinitionUtils
                .getAttributeContent(BaseApiClient.ATTRIBUTE_KEYSTORE_PASSWORD, authAttributes, true);
        ...
        FileAttributeContentV2 trustStoreData = AttributeDefinitionUtils
                .getAttributeContent(BaseApiClient.ATTRIBUTE_TRUSTSTORE, authAttributes, true);
        ...
        SecretAttributeContentV2 trustStorePassword = AttributeDefinitionUtils
                .getAttributeContent(BaseApiClient.ATTRIBUTE_TRUSTSTORE_PASSWORD, authAttributes, true);
        ...
        log
                .debug("Converted CERTIFICATE auth with keystore: {}, truststore: {}",
                        keyStoreData != null ? "present" : "absent", trustStoreData != null ? "present" : "absent");

        return ConnectorAuth.builder().type("CERTIFICATE").attributes(attributes).build();
    }
}
