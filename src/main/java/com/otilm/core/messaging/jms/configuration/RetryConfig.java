...
public class RetryConfig {
    ...
    /**
     * Retry template for JMS listeners — logging only, no pool interaction. Listener containers use the raw
     * {@code ConnectionFactory} bean, not the pooled one.
     */
    @Bean
    ...
    /**
     * Retry template for JMS producers — clears the producer connection pool on connection-level failures to force a
     * fresh connection on the next retry.
     */
    @Bean
