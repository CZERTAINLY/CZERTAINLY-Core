...
public class RsaEncryptionAttributes {
    ...
    public static final String ATTRIBUTE_DATA_RSA_ENC_SCHEME_NAME = "data_rsaEncScheme"; // this would be OAEP or
                                                                                         // PKCS1-v1_5 according the RFC
                                                                                         // 8017
    ...
    public static final String ATTRIBUTE_DATA_RSA_OAEP_HASH_NAME = "data_rsaOaepHash"; // this would be SHA-1, SHA-256,
                                                                                       // SHA-384, SHA-512
    ...
    public static final String ATTRIBUTE_DATA_RSA_OAEP_USE_MGF_NAME = "data_rsaOaepMgf"; // true or false, because only
                                                                                         // MGF1 is supported by the RFC
                                                                                         // 8017
    ...
    public static List<BaseAttribute> getRsaEncryptionAttributes() {
        return List.of(buildDataEncryptionScheme(), buildDataOaepHash(), buildDataOaepMgf());
    }
