...
public interface ComplianceProfileExternalService {
     ...
     */
    ComplianceProfileDto createComplianceProfile(ComplianceProfileRequestDto request) throws AlreadyExistException,
            NotFoundException, ValidationException, AttributeException, ConnectorException;

    /**
     * Add a rule to a compliance profile
     *
     * @param uuid Uuid of the compliance provider
     * @param request Parameters for adding a new rule to the compliance profile. See
     * {@link ComplianceRuleAdditionRequestDto}
     * @return Compliance Profile Dto
     ...
     */
    ComplianceProfileRuleDto addRule(SecuredUUID uuid, ComplianceRuleAdditionRequestDto request)
     ...
     */
    ComplianceProfileRuleDto removeRule(SecuredUUID uuid, ComplianceRuleDeletionRequestDto request)
     ...
     */
    ComplianceProfileDto addGroup(SecuredUUID uuid, ComplianceGroupRequestDto request)
     ...
     */
    ComplianceProfileDto removeGroup(SecuredUUID uuid, ComplianceGroupRequestDto request)
            throws NotFoundException, ConnectorException;
     ...
     */
    List<ComplianceRulesListResponseDto> getComplianceRules(String complianceProviderUuid, String kind,
     ...
     */
    List<ComplianceGroupsListResponseDto> getComplianceGroups(String complianceProviderUuid, String kind)
            throws NotFoundException, ConnectorException;
     ...
     */
    void associateProfile(SecuredUUID uuid, RaProfileAssociationRequestDto raProfiles)
