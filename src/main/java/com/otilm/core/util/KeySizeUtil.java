...
public class KeySizeUtil {
    ...
    private static final Map<FalconParameterSpec, Integer> falconKeySizes = Map
            .of(FalconParameterSpec.falcon_512, 7176, FalconParameterSpec.falcon_1024, 14344);

    private static final Map<MLDSAParameterSpec, Integer> mldsaKeySizes = Map
            .of(MLDSAParameterSpec.ml_dsa_44, 10496, MLDSAParameterSpec.ml_dsa_44_with_sha512, 10496,
                    MLDSAParameterSpec.ml_dsa_65, 15616, MLDSAParameterSpec.ml_dsa_65_with_sha512, 15616,
                    MLDSAParameterSpec.ml_dsa_87, 20736, MLDSAParameterSpec.ml_dsa_87_with_sha512, 20736);

    private static final Map<SLHDSAParameterSpec, Integer> slhdsaKeySizes = Map
            .ofEntries(Map.entry(SLHDSAParameterSpec.slh_dsa_sha2_128f, 256),
    ...
    /**
     * Method to get the key length from the public Key. For the Post Quantum Algorithm the key size is taken from the
     * static map
     *
