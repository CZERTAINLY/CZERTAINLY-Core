...
/**
 * This class contains the methods for generating and validating the nonce for all the ACME requests. This class uses
 * SecureRandom class from spring security for Nonce generation
 */
