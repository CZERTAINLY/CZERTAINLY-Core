 ...
 * <p>
 * This component transforms proxy names into safe, URL-friendly, and database-compatible codes by removing diacritics,
 * normalizing whitespace, and sanitizing special characters. The resulting codes are abbreviated to a maximum length
...
public class ProxyCodeHelper {
     ...
     *
     * @param proxyNamePrefix the prefix to prepend to generated codes, defaults to "proxy-" if not configured via
     * {@code proxy.name-prefix}
     */
