...
public class PlatformX500NameStyle extends BCStrictStyle {
    ...
    public static final PlatformX500NameStyle DEFAULT = new PlatformX500NameStyle(false);
    public static final PlatformX500NameStyle NORMALIZED = new PlatformX500NameStyle(true);
