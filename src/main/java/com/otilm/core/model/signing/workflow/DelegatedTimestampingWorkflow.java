 ...
 *
 * <p>
 * Contains only the common validation fields declared on {@link TimestampingWorkflow}.
 *
 ...
 */
public record DelegatedTimestampingWorkflow(String defaultPolicyId, List<String> allowedPolicyIds,
