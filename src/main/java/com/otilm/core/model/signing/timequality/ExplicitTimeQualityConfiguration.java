 ...
 */
public record ExplicitTimeQualityConfiguration(UUID uuid, String name, Duration accuracy, List<String> ntpServers,
        Duration ntpCheckInterval, Integer ntpSamplesPerServer, Duration ntpCheckTimeout,
        Integer ntpServersMinReachable, Duration maxClockDrift,
        boolean leapSecondGuard) implements TimeQualityConfigurationModel {
