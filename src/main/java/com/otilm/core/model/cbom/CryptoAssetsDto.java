...
public class CryptoAssetsDto implements Serializable {
    ...
    @NotNull
    @Valid
    @Schema(description = "Algorithms statistics", requiredMode = Schema.RequiredMode.REQUIRED)
    private CryptoAssetCountDto algorithms;

    @NotNull
    @Valid
    @Schema(description = "Certificates statistics", requiredMode = Schema.RequiredMode.REQUIRED)
    private CryptoAssetCountDto certificates;

    @NotNull
    @Valid
    @Schema(description = "Protocols statistics", requiredMode = Schema.RequiredMode.REQUIRED)
    private CryptoAssetCountDto protocols;

    @NotNull
    @Valid
    @Schema(description = "Related crypto materials statistics", requiredMode = Schema.RequiredMode.REQUIRED)
