...
public record ImmutableTokenInstanceFullModel(UUID uuid, String tokenInstanceUuid, String name,
        ...
        Connector connector, ImmutableConnectorInterface connectorInterface,
    ...
    public static ImmutableTokenInstanceFullModel from(TokenInstanceReference value) {
        ...
        return new ImmutableTokenInstanceFullModel(value.getUuid(), value.getTokenInstanceUuid(), value.getName(),
                ...
                value.getConnectorInterfaceUuid(), value.getConnector(),
    ...
    public TokenInstanceFullModel withNewStatus(TokenInstanceStatus newStatus) {
        return new ImmutableTokenInstanceFullModel(uuid, tokenInstanceUuid, name, newStatus, kind, connectorUuid,
                connectorName, connectorInterfaceUuid, connector, connectorInterface, tokenProfiles);
    }
}
