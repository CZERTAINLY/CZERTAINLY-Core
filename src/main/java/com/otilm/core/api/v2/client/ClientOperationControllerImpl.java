...
public class ClientOperationControllerImpl implements ClientOperationController {
    ...
    public ClientCertificateDataResponseDto issueExistingCertificate(String authorityUuid,
        ...
        return clientOperationService
                .issueExistingCertificate(SecuredParentUUID.fromString(authorityUuid),
    ...
    public ClientCertificateDataResponseDto issueCertificate(String authorityUuid,
        ...
        return clientOperationService
                .issueCertificate(SecuredParentUUID.fromString(authorityUuid), SecuredUUID.fromString(raProfileUuid),
                        request, null);
    }
    ...
    public void revokeCertificate(String authorityUuid,
        ...
        clientOperationService
                .revokeCertificate(SecuredParentUUID.fromString(authorityUuid), SecuredUUID.fromString(raProfileUuid),
                        certificateUuid, request);
    }
    ...
    public void validateIssueCertificateAttributes(String authorityUuid,
        ...
        clientOperationService
                .validateIssueCertificateAttributes(SecuredParentUUID.fromString(authorityUuid),
                        SecuredUUID.fromString(raProfileUuid), attributes);
    }
    ...
    public List<BaseAttribute> listRegisterCertificateAttributes(String authorityUuid,
            ...
            throws ConnectorException, NotFoundException {
        return clientOperationService
                .listRegisterCertificateAttributes(SecuredParentUUID.fromString(authorityUuid),
                        SecuredUUID.fromString(raProfileUuid));
    }
    ...
    public void validateRevokeCertificateAttributes(String authorityUuid,
            ...
            throws ConnectorException, ValidationException, NotFoundException {
        clientOperationService
                .validateRevokeCertificateAttributes(SecuredParentUUID.fromString(authorityUuid),
                        SecuredUUID.fromString(raProfileUuid), attributes);
    }
    ...
    public void manuallyConfirmRevoke(String authorityUuid,
        ...
        clientOperationService
                .manuallyConfirmRevoke(SecuredParentUUID.fromString(authorityUuid),
                        SecuredUUID.fromString(raProfileUuid), certificateUuid);
    }
    ...
    public com.otilm.api.model.core.certificate.CertificateDetailDto cancelPendingCertificateOperation(
            ...
            @LogResource(uuid = true) String certificateUuid,
            com.otilm.api.model.client.certificate.CancelPendingCertificateRequestDto request)
            throws NotFoundException {
        return clientOperationService
                .cancelPendingCertificateOperation(SecuredParentUUID.fromString(authorityUuid),
                        SecuredUUID.fromString(raProfileUuid), certificateUuid, request);
    }
    ...
    public ClientCertificateDataResponseDto registerCertificate(String authorityUuid,
        ...
        return clientOperationService
                .registerCertificate(SecuredParentUUID.fromString(authorityUuid), SecuredUUID.fromString(raProfileUuid),
                        request);
    }
    ...
    public AvailableOperationsDto listAvailableOperations(
        ...
        return clientOperationService
                .listAvailableOperations(SecuredParentUUID.fromString(authorityUuid),
                        SecuredUUID.fromString(raProfileUuid));
    }
}
