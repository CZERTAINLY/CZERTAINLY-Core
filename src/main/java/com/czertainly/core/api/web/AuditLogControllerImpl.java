...
public class AuditLogControllerImpl implements AuditLogController {
    ...
    @Override
    @AuthEndpoint(resourceName = ResourceName.AUDIT_LOG, actionName = ActionName.LIST, isListingEndPoint = true)
    ...
    @Override
    @AuthEndpoint(resourceName = ResourceName.ADMIN, actionName = ActionName.EXPORT)
