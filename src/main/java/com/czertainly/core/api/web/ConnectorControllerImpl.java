...
public class ConnectorControllerImpl implements ConnectorController {
    ...
    @Override
    @AuthEndpoint(resourceName = Resource.CONNECTOR, actionName = ResourceAction.DELETE)
    ...
    @Override
    @AuthEndpoint(resourceName = Resource.CONNECTOR, actionName = ResourceAction.FORCE_DELETE)
