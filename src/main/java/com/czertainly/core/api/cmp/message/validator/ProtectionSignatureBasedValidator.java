...
import com.czertainly.core.api.cmp.message.util.CertificationUtil;
...
public class ProtectionSignatureBasedValidator implements Validator<PKIMessage, Void> {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(ProtectionSignatureBasedValidator.class.getName());
    ...
    public Void validate(PKIMessage message) throws CmpException {
        ...
        try {
            List<X509Certificate> extraCertsAsX509 = CertificationUtil.toX509Certificates(extraCerts);
