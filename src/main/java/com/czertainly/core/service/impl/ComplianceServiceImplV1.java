...
import com.czertainly.api.model.connector.compliance.*;
...
import com.czertainly.core.service.ComplianceServiceV1;
...
@Service
@Transactional
public class ComplianceServiceImplV1 implements ComplianceServiceV1 {

    private static final Logger logger = LoggerFactory.getLogger(ComplianceServiceImplV1.class);
