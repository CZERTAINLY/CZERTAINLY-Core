...
public class ResourceServiceImpl implements ResourceService {
    ...
    @Override
    public List<ResponseAttributeDto<?>> updateAttributeContentForObject(Resource resource, SecuredUUID objectUuid, UUID attributeUuid, List<? extends AttributeContent> attributeContentItems) throws NotFoundException, AttributeException {
