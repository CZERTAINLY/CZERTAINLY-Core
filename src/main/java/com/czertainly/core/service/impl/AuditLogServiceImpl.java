...
public class AuditLogServiceImpl implements AuditLogService {
    ...
    public void purgeAuditLogs(final List<SearchFilterRequestDto> filters) {
        final TriFunction<Root<AuditLog>, CriteriaBuilder, CriteriaDelete, jakarta.persistence.criteria.Predicate> additionalWhereClause = (root, cb, cd) -> FilterPredicatesBuilder.getFiltersPredicate(cb, cd, root, filters);
