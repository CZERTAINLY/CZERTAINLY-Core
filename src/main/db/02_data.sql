...
insert into public.endpoint (id,context,"method","name",required,function_group_id,uuid) values
	 (nextval('endpoint_id_seq'),'/v1/authorityProvider/authorities','GET','listCAInstances',true,(select id from function_group where code = 'AUTHORITY_PROVIDER'),'e3521dd0-e150-4676-a79c-30a33e62889c'),
	 (nextval('endpoint_id_seq'),'/v1/authorityProvider/authorities/{uuid}','GET','getCAInstance',true,(select id from function_group where code = 'AUTHORITY_PROVIDER'),'924ac89a-7376-4ac8-8c15-ecb7d9e8ca16'),
	 (nextval('endpoint_id_seq'),'/v1/authorityProvider/authorities','POST','createCAInstance',true,(select id from function_group where code = 'AUTHORITY_PROVIDER'),'9bf9cd3b-73de-4c1c-a712-7396e9dc78e5'),
	 (nextval('endpoint_id_seq'),'/v1/authorityProvider/authorities/{uuid}','POST','updateCAInstance',true,(select id from function_group where code = 'AUTHORITY_PROVIDER'),'51c5b673-0e6e-4b8d-a31b-1b35835b4025'),
	 (nextval('endpoint_id_seq'),'/v1/authorityProvider/authorities/{uuid}','DELETE','removeCAInstance',false,(select id from function_group where code = 'AUTHORITY_PROVIDER'),'f83d858a-d63b-48e7-b22c-fdb7f7e3d9b1'),
...
insert into public.endpoint (id,context,"method","name",required,function_group_id,uuid) values
	 ...
	 (nextval('endpoint_id_seq'),'/v1/authorityProvider/authorities/{uuid}','DELETE','removeCAInstance',false,(select id from function_group where code = 'LEGACY_AUTHORITY_PROVIDER'),'b3592167-af2a-44b3-89d2-e4bfd000caa4');
insert into public.endpoint (id,context,"method","name",required,function_group_id,uuid) values
	 (nextval('endpoint_id_seq'),'/v1/authorityProvider/authorities','POST','createCAInstance',true,(select id from function_group where code = 'LEGACY_AUTHORITY_PROVIDER'),'6350c3bb-57ef-4416-964b-0254df28131e'),
	 (nextval('endpoint_id_seq'),'/v1/authorityProvider/authorities/{uuid}','GET','getCAInstance',true,(select id from function_group where code = 'LEGACY_AUTHORITY_PROVIDER'),'1692cec0-50aa-46a3-be7f-b32e6a752d2a'),
	 (nextval('endpoint_id_seq'),'/v1/authorityProvider/authorities','GET','listCAInstances',true,(select id from function_group where code = 'LEGACY_AUTHORITY_PROVIDER'),'cb1ae7eb-a97b-44bd-bf76-46ae96e32985'),
	 (nextval('endpoint_id_seq'),'/v1/authorityProvider/authorities/{uuid}','POST','updateCAInstance',true,(select id from function_group where code = 'LEGACY_AUTHORITY_PROVIDER'),'06f1f14f-328b-40f7-8f34-f168619e3a3a'),
	 ...
	 (nextval('endpoint_id_seq'),'/v1/authorityProvider/authorities/{uuid}/raProfiles/attributes','GET','listRAProfileAttributes',true,(select id from function_group where code = 'AUTHORITY_PROVIDER'),'e43155b6-51ad-46e0-a60c-176ee5e6dfea'),
