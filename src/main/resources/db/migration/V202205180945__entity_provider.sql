...
insert into endpoint (id,context,"method","name",required,function_group_id,uuid) values
    ...
    (nextval('endpoint_id_seq'),'/v1/entityProvider/entities/{entityUuid}','POST','updateEntityInstance',true,(select id from function_group where code = 'ENTITY_PROVIDER'),'7e6b5ed7-3ffa-4c51-82c8-9f636c61ddb9'),
