...
public class KurMessageHandlerTest {
    ...
    public void setUp() throws Exception {
        ...
        issuedCertificated = CmpEntityUtil
                .createCertificate(CertificateState.ISSUED,
                        CmpEntityUtil
                                .createCertContent(CertificateUtil.getThumbprint(x509Certificate), contentOfIssuedCert),
    ...
    public void test_handleOk() throws Exception {
        ...
        // -- GIVEN
        given(certificateRepository.findBySerialNumberIgnoreCase(any())).willReturn(Optional.of(issuedCertificated));
    ...
    public void test_handle_certificate_for_re_key_not_found() throws Exception {
        ...
        // -- GIVEN
        given(certificateRepository.findBySerialNumberIgnoreCase(any())).willReturn(Optional.empty());
