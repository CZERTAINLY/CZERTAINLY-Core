...
class IdentityTablesTest {
    ...
    /**
     * The exact artifact every published cross-implementation agreement figure was measured against.
     *
     * <p>
     ...
     * quoted throughout this package no longer describe the shipped build. Bump {@code RULESET_VERSION} in the same
     * commit and re-run the vectors before changing the value here.
     */
    @Test
    void theShippedTablesAreTheRatifiedArtifact() throws IOException {
        try (InputStream stream = IdentityTablesTest.class
            ...
            assertThat(Digests.sha256HexOfBytes(stream.readAllBytes()))
                    .describedAs("the decision tables are ratified data; editing them re-keys the inventory")
                    .isEqualTo("1331969bb507eb65c887eec44321af8768f752862afe344e528c86d3de53407b");
        }
    }
