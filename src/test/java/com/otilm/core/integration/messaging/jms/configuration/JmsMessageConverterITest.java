...
/**
 * <p>
 * This test verifies that the MessageConverter bean configured in {@link JmsConfig} correctly handles Java 8 date/time
 * types (OffsetDateTime, LocalDateTime, etc.).
 * </p>
 */
class JmsMessageConverterITest extends BaseSpringBootTest {
    ...
    void shouldSerializeOffsetDateTimeUsingAppMessageConverter() throws JMSException {
        ...
        TestMessageWithOffsetDateTime message = new TestMessageWithOffsetDateTime("test-id", now,
