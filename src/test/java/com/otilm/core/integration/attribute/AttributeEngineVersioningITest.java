...
class AttributeEngineVersioningITest extends BaseSpringBootTest {
    ...
    /**
     * Extracts the String data from the first content item of the first attribute in a ResponseAttribute list. Assumes
     * the list has exactly one V3 attribute with exactly one STRING item.
     */
    ...
    /**
     * Returns the number of content items of the first attribute in the list. Assumes the list has at least one V3
     * attribute.
     */
    ...
    /**
     * Verify that ObjectAttributeContentInfo constructed with the existing convenience constructors always produces
     * objectVersion() == null, and the two new version-carrying constructors produce the expected value.
     */
    @Test
    void testObjectAttributeContentInfoVersionConstructors() {
        ...
        Assertions
                .assertNull(ObjectAttributeContentInfo
                        .builder(VERSIONED_RESOURCE, obj)
                        .connector(conn)
                        .build()
                        .objectVersion());
        Assertions
        ...
        Assertions
                .assertNull(ObjectAttributeContentInfo
                        .builder(VERSIONED_RESOURCE, obj)
                        .connector(conn)
                        .source(Resource.CERTIFICATE, UUID.randomUUID())
                        .build()
                        .objectVersion());

        // New constructors → carry version
        ObjectAttributeContentInfo v1Info = ObjectAttributeContentInfo
                .builder(VERSIONED_RESOURCE, obj)
                .connector(conn)
                .version(1)
                .build();
        ...
        ObjectAttributeContentInfo v2WithPurpose = ObjectAttributeContentInfo
                .builder(VERSIONED_RESOURCE, obj)
                .connector(conn)
                .purpose("myPurpose")
                .version(2)
    ...
    /**
     * Backward-compatibility: writing and reading attribute content WITHOUT an objectVersion (null) must behave exactly
    ...
    void testUnversionedReadWriteStillWorks() throws AttributeException, NotFoundException {
        ...
        attributeEngine
                .updateObjectDataAttributesContent(ObjectAttributeContentInfo
                        .builder(VERSIONED_RESOURCE, objectUuid)
                        .connector(connector.getUuid())
                        .operation(OPERATION_SIGN)
                        .build(), List.of(buildRequest(def, "unversionedValue")));

        // read back with the unversioned overload
        var content = attributeEngine
    ...
    /**
     * Core isolation test: writing attributes for v1 and v2 of the same object must produce independent rows. Reading
     * v1 must not return v2 values and vice versa.
     */
    @Test
    void testVersionIsolation() throws AttributeException, NotFoundException {
        ...
        attributeEngine
                .updateObjectDataAttributesContent(ObjectAttributeContentInfo
                        ...
                        .operation(OPERATION_SIGN)
                        .version(1)
                        .build(), List.of(buildRequest(def, "value_v1")));
        attributeEngine
                .updateObjectDataAttributesContent(ObjectAttributeContentInfo
                        .builder(VERSIONED_RESOURCE, objectUuid)
                        .connector(connector.getUuid())
                        .operation(OPERATION_SIGN)
                        .version(2)
                        .build(), List.of(buildRequest(def, "value_v2")));

        var v1Content = attributeEngine
                .getObjectDataAttributesContent(ObjectAttributeContentInfo
                        .builder(VERSIONED_RESOURCE, objectUuid)
                        .connector(connector.getUuid())
                        .operation(OPERATION_SIGN)
    ...
    void testInPlaceUpdateOfV1DoesNotAffectV2() throws AttributeException, NotFoundException {
        ...
        attributeEngine
                .updateObjectDataAttributesContent(ObjectAttributeContentInfo
                        ...
                        .operation(OPERATION_SIGN)
                        .version(1)
                        .build(), List.of(buildRequest(def, "v1_original")));
        attributeEngine
                .updateObjectDataAttributesContent(ObjectAttributeContentInfo
                        .builder(VERSIONED_RESOURCE, objectUuid)
                        .connector(connector.getUuid())
                        .operation(OPERATION_SIGN)
                        .version(2)
                        .build(), List.of(buildRequest(def, "v2_value")));
        ...
        attributeEngine
                .updateObjectDataAttributesContent(ObjectAttributeContentInfo
                        ...
                        .operation(OPERATION_SIGN)
                        .version(1)
                        .build(), List.of(buildRequest(def, "v1_updated")));

        Assertions
                .assertEquals("v1_updated",
                        firstStringValue(attributeEngine
                                .getObjectDataAttributesContent(ObjectAttributeContentInfo
                                        .builder(VERSIONED_RESOURCE, objectUuid)
                                        .connector(connector.getUuid())
                                        .operation(OPERATION_SIGN)
    ...
    void testDeleteV1LeavesV2Intact() throws AttributeException, NotFoundException {
        ...
        attributeEngine
                .updateObjectDataAttributesContent(ObjectAttributeContentInfo
                        ...
                        .operation(OPERATION_SIGN)
                        .version(1)
                        .build(), List.of(buildRequest(def, "v1_value")));
        attributeEngine
                .updateObjectDataAttributesContent(ObjectAttributeContentInfo
                        .builder(VERSIONED_RESOURCE, objectUuid)
                        .connector(connector.getUuid())
    ...
    void testDeleteObjectAttributeContentRemovesAllVersions() throws AttributeException, NotFoundException {
        ...
        for (int v = 1; v <= 3; v++) {
            attributeEngine
                    .updateObjectDataAttributesContent(ObjectAttributeContentInfo
                            ...
                            .operation(OPERATION_SIGN)
                            .version(v)
                            .build(), List.of(buildRequest(def, "value_v" + v)));
        }

        var allBefore = attributeContent2ObjectRepository
                .getAllObjectDataAttributesContent(VERSIONED_RESOURCE, objectUuid);
        ...
        ObjectAttributeContentInfo anyVersionInfo = ObjectAttributeContentInfo
                .builder(VERSIONED_RESOURCE, objectUuid)
                .connector(connector.getUuid())
                .build();
        attributeEngine.deleteObjectAttributesContent(AttributeType.DATA, anyVersionInfo);

        var allAfter = attributeContent2ObjectRepository
                .getAllObjectDataAttributesContent(VERSIONED_RESOURCE, objectUuid);
        Assertions
                .assertTrue(allAfter.isEmpty(), "all versioned rows must be gone after deleteObjectAttributesContent");
    }

    /**
     * Deduplication fix: the same attribute definition content can exist for v1 and v2 of the same object as separate,
    ...
    void testDeduplicationIsScopedPerVersion() throws AttributeException, NotFoundException {
        ...
        attributeEngine
                .updateObjectDataAttributesContent(ObjectAttributeContentInfo
                        ...
                        .operation(OPERATION_SIGN)
                        .version(1)
                        .build(), List.of(buildRequest(def, "same_value")));
        attributeEngine
                .updateObjectDataAttributesContent(ObjectAttributeContentInfo
                        .builder(VERSIONED_RESOURCE, objectUuid)
                        .connector(connector.getUuid())
        ...
        var allRows = attributeContent2ObjectRepository
                .getAllObjectDataAttributesContent(VERSIONED_RESOURCE, objectUuid);
        Assertions.assertEquals(2, allRows.size(), "dedup check must allow two separate mapping rows for v1 and v2");
    }

    /**
     * Namespace isolation: unversioned (null version) rows and versioned rows for the same objectUuid must not bleed
     * into each other's read queries.
     */
    @Test
    void testUnversionedAndVersionedRowsDontBleed() throws AttributeException, NotFoundException {
        ...
        attributeEngine
                .updateObjectDataAttributesContent(ObjectAttributeContentInfo
                        ...
                        .connector(connector.getUuid())
                        .operation(OPERATION_SIGN)
                        .build(), List.of(buildRequest(def, "unversioned_value")));
        ...
        var unversioned = attributeEngine
                .getObjectDataAttributesContent(ObjectAttributeContentInfo
                        .builder(VERSIONED_RESOURCE, objectUuid)
                        .connector(connector.getUuid())
                        .operation(OPERATION_SIGN)
        ...
        Assertions
                .assertEquals("unversioned_value", firstStringValue(unversioned),
        ...
        Assertions
                .assertEquals("v1_value", firstStringValue(v1Content), "Versioned read (v1) must return v1_value only");
    }
     ...
     *
     * <p>
     * Scenario: version 1 is written with connector A. The resource is then updated in-place (no version bump) with
     * connector B. After the replacement, the only rows in the DB for this version+operation must belong to connector
     * B.
     */
    @Test
    void testReplaceVersionedOperation_connectorChange_noStaleRows() throws AttributeException, NotFoundException {
        ...
        attributeEngine
                .updateObjectDataAttributesContent(ObjectAttributeContentInfo
                        .builder(VERSIONED_RESOURCE, objectUuid)
                        .connector(connectorA.getUuid())
                        .operation(OPERATION_FORMAT)
                        .version(1)
                        .build(), List.of(buildRequest(defA, "connA_value")));

        // Verify connector A's rows exist
        var beforeReplace = attributeEngine
                .getObjectDataAttributesContent(ObjectAttributeContentInfo
                        .builder(VERSIONED_RESOURCE, objectUuid)
                        .connector(connectorA.getUuid())
                        .operation(OPERATION_FORMAT)
        ...
        attributeEngine
                .replaceObjectDataAttributesContent(ObjectAttributeContentInfo
                        .builder(VERSIONED_RESOURCE, objectUuid)
                        .connector(connectorB.getUuid())
                        .operation(OPERATION_FORMAT)
                        .version(1)
                        .build(), List.of(buildRequest(defB, "connB_value")));

        // Connector A rows must be gone
        var staleRows = attributeEngine
                .getObjectDataAttributesContent(ObjectAttributeContentInfo
                        .builder(VERSIONED_RESOURCE, objectUuid)
                        .connector(connectorA.getUuid())
                        .operation(OPERATION_FORMAT)
                        .version(1)
                        .build());
        Assertions.assertTrue(staleRows.isEmpty(), "stale rows from connector A must be purged after connector change");

        // Connector B rows must be present with the new value
        var freshRows = attributeEngine
                .getObjectDataAttributesContent(ObjectAttributeContentInfo
                        .builder(VERSIONED_RESOURCE, objectUuid)
                        .connector(connectorB.getUuid())
                        .operation(OPERATION_FORMAT)
    ...
    void testReplaceVersionedOperation_emptyList_clearsExistingRows() throws AttributeException, NotFoundException {
        ...
        attributeEngine
                .updateObjectDataAttributesContent(ObjectAttributeContentInfo
                        ...
                        .operation(OPERATION_SIGN)
                        .version(1)
                        .build(), List.of(buildRequest(def, "sign_value")));
        ...
        var afterSwitch = attributeEngine
                .getObjectDataAttributesContent(ObjectAttributeContentInfo
                        .builder(VERSIONED_RESOURCE, objectUuid)
                        .connector(connector.getUuid())
                        .operation(OPERATION_SIGN)
    ...
    void testReplaceVersionedOperation_doesNotAffectOtherVersions() throws AttributeException, NotFoundException {
        ...
        attributeEngine
                .replaceObjectDataAttributesContent(ObjectAttributeContentInfo
                        ...
                        .operation(OPERATION_FORMAT)
                        .version(1)
                        .build(), List.of(buildRequest(def, "v1_replaced")));

        Assertions
                .assertEquals("v1_replaced",
                        firstStringValue(attributeEngine
                                .getObjectDataAttributesContent(ObjectAttributeContentInfo
                                        .builder(VERSIONED_RESOURCE, objectUuid)
                                        .connector(connector.getUuid())
    ...
    void testReplaceVersionedOperation_requiresNonNullVersion() {
        ObjectAttributeContentInfo noVersion = ObjectAttributeContentInfo
                .builder(VERSIONED_RESOURCE, UUID.randomUUID())
                .connector(connector.getUuid())
                .operation(OPERATION_SIGN)
                .build();
    ...
    void testReplaceVersionedOperation_requiresNonNullOperation() {
        ObjectAttributeContentInfo noOperation = ObjectAttributeContentInfo
                .builder(VERSIONED_RESOURCE, UUID.randomUUID())
                .connector(connector.getUuid())
                .version(1)
                .build();
    ...
    void testReplaceVersionedOperation_doesNotAffectOtherPurposes() throws AttributeException, NotFoundException {
        ...
        attributeEngine
                .updateObjectDataAttributesContent(ObjectAttributeContentInfo
                        ...
                        .operation(OPERATION_SIGN)
                        .version(1)
                        .build(), List.of(buildRequest(def, "primary_value")));
        attributeEngine
                .updateObjectDataAttributesContent(ObjectAttributeContentInfo
                        .builder(VERSIONED_RESOURCE, objectUuid)
                        .connector(connector.getUuid())
                        ...
                        .purpose(altPurpose)
                        .version(1)
                        .build(), List.of(buildRequest(def, "alt_value")));

        // Sanity: both are readable before the replace.
        Assertions
                .assertEquals("primary_value",
                        firstStringValue(attributeEngine
                                .getObjectDataAttributesContent(ObjectAttributeContentInfo
                                        .builder(VERSIONED_RESOURCE, objectUuid)
                                        .connector(connector.getUuid())
        ...
        attributeEngine
                .replaceObjectDataAttributesContent(ObjectAttributeContentInfo
                        ...
                        .operation(OPERATION_SIGN)
                        .version(1)
                        .build(), List.of(buildRequest(def, "primary_replaced")));

        // The primary purpose must show the new value.
        Assertions
                .assertEquals("primary_replaced",
                        firstStringValue(attributeEngine
                                .getObjectDataAttributesContent(ObjectAttributeContentInfo
                                        .builder(VERSIONED_RESOURCE, objectUuid)
                                        .connector(connector.getUuid())
        ...
        var altAfter = attributeEngine
                .getObjectDataAttributesContent(ObjectAttributeContentInfo
                        ...
                        .build());
        Assertions
                .assertEquals(1, altAfter.size(),
                        "alt-purpose rows must survive the replace of the primary-purpose set");
        Assertions
                .assertEquals("alt_value", firstStringValue(altAfter),
        ...
        Assertions
                .assertFalse(attributeEngine
                        .getObjectDataAttributesContent(ObjectAttributeContentInfo
                                ...
                                .version(1)
                                .build())
                        .isEmpty(), "v1 must still have rows");
        ...
        Assertions
                .assertFalse(attributeEngine
                        .getObjectDataAttributesContent(ObjectAttributeContentInfo
                                ...
                                .version(3)
                                .build())
                        .isEmpty(), "v3 must still have rows");
    }
        ...
        Assertions
                .assertTrue(attributeEngine
                        .getObjectDataAttributesContent(ObjectAttributeContentInfo
                                ...
                                .version(1)
                                .build())
                        .isEmpty(), "v1 rows must be deleted");

        // unversioned row must survive
        var unversionedAfter = attributeEngine
                .getObjectDataAttributesContent(ObjectAttributeContentInfo
                        .builder(VERSIONED_RESOURCE, objectUuid)
                        .connector(connector.getUuid())
                        .operation(OPERATION_SIGN)
                        .build());
        Assertions
                .assertEquals(1, unversionedAfter.size(),
    ...
    void testDeleteForVersion_requiresNonNullVersion() {
        ...
        Assertions
                .assertThrows(IllegalArgumentException.class,
                        () -> attributeEngine
                                .deleteObjectAttributeContentForVersion(VERSIONED_RESOURCE, randomUUID, null),
                        "must throw when version is null");
    }

    /**
     * Contrast between deleteObjectAttributeContent and deleteObjectAttributeContentForVersion: when versioned rows
     * exist for multiple versions alongside unversioned rows, deleteObjectAttributeContent removes everything, while
     * deleteObjectAttributeContentForVersion is selective.
     * <p>
    ...
    void testDelete_vs_deleteForVersion_boundary() throws AttributeException, NotFoundException {
        ...
        for (UUID oid : List.of(objectForAll, objectForOne)) {
            attributeEngine
                    .updateObjectDataAttributesContent(ObjectAttributeContentInfo
                            .builder(VERSIONED_RESOURCE, oid)
                            .connector(connector.getUuid())
                            .operation(OPERATION_SIGN)
                            .build(), List.of(buildRequest(def, "unversioned")));
            attributeEngine
                    .updateObjectDataAttributesContent(ObjectAttributeContentInfo
                            .builder(VERSIONED_RESOURCE, oid)
                            .connector(connector.getUuid())
                            .operation(OPERATION_SIGN)
                            .version(1)
                            .build(), List.of(buildRequest(def, "v1")));
            attributeEngine
                    .updateObjectDataAttributesContent(ObjectAttributeContentInfo
                            .builder(VERSIONED_RESOURCE, oid)
                            .connector(connector.getUuid())
                            .operation(OPERATION_SIGN)
                            .version(2)
                            .build(), List.of(buildRequest(def, "v2")));
        }
        ...
        Assertions
                .assertTrue(
                        attributeContent2ObjectRepository
                                .getAllObjectDataAttributesContent(VERSIONED_RESOURCE, objectForAll)
                                .isEmpty(),
        ...
        var remaining = attributeContent2ObjectRepository
                .getAllObjectDataAttributesContent(VERSIONED_RESOURCE, objectForOne);
        Assertions
                .assertEquals(2, remaining.size(), "deleteForVersion(1) must leave unversioned row and v2 row intact");
    }
    ...
    void testVersionedWriteReadWithPurpose() throws AttributeException, NotFoundException {
        ...
        attributeEngine
                .updateObjectDataAttributesContent(ObjectAttributeContentInfo
                        ...
                        .purpose(purpose)
                        .version(1)
                        .build(), List.of(buildRequest(def, "purpose_v1")));
        attributeEngine
                .updateObjectDataAttributesContent(ObjectAttributeContentInfo
                        .builder(VERSIONED_RESOURCE, objectUuid)
                        .connector(connector.getUuid())
                        ...
                        .purpose(purpose)
                        .version(2)
                        .build(), List.of(buildRequest(def, "purpose_v2")));
    ...
    void testGetRequestObjectDataAttributesContentVersioned() throws AttributeException, NotFoundException {
        ...
        attributeEngine
                .updateObjectDataAttributesContent(ObjectAttributeContentInfo
                        ...
                        .operation(OPERATION_SIGN)
                        .version(1)
                        .build(), List.of(buildRequest(def, "req_v1")));
        attributeEngine
                .updateObjectDataAttributesContent(ObjectAttributeContentInfo
                        .builder(VERSIONED_RESOURCE, objectUuid)
                        .connector(connector.getUuid())
                        .operation(OPERATION_SIGN)
                        .version(2)
                        .build(), List.of(buildRequest(def, "req_v2")));

        var reqV1 = attributeEngine
    ...
    /**
     * Builds a minimal MetadataAttributeV3 with a single STRING content item and persists it for the given object via
    ...
    /**
     * getMappedMetadataContent must return only the metadata rows belonging to the requested version. Writing meta for
     * v1 and v2 of the same object and reading each version must exclusively return that version's value.
     */
    @Test
    void testGetMappedMetadataContentIsVersionScoped() throws AttributeException {
        ...
        ObjectAttributeContentInfo v1Info = ObjectAttributeContentInfo
                ...
                .version(1)
                .build();
        ObjectAttributeContentInfo v2Info = ObjectAttributeContentInfo
                .builder(VERSIONED_RESOURCE, objectUuid)
                .connector(connector.getUuid())
                .version(2)
                .build();
        ...
        String v1Value = v1Meta
                ...
                .orElse(null);
        Assertions
                .assertEquals("meta_value_v1", v1Value,
        ...
        String v2Value = v2Meta
                ...
                .orElse(null);
        Assertions
                .assertEquals("meta_value_v2", v2Value,
    ...
    void testVersionedDeleteWithNullOperationDeletesCorrectRows() throws AttributeException, NotFoundException {
        ...
        Assertions.assertTrue(v1After.isEmpty(), "v1 attributes with null operation must be deleted");

        // v2 must be untouched
        var v2After = attributeEngine.getObjectDataAttributesContent(v2Info);
        Assertions.assertEquals(1, v2After.size(), "v2 attributes with null operation must remain after deleting v1");
        Assertions.assertEquals("null_op_v2", firstStringValue(v2After), "v2 value must be unchanged");
    }

    @Test
    void testUnversionedDeleteWithNullOperationAndNoPurposeDeletesCorrectRows()
        ...
        ObjectAttributeContentInfo info = ObjectAttributeContentInfo
                .builder(VERSIONED_RESOURCE, objectUuid)
                .connector(connector.getUuid())
                .build(); // null operation, null purpose, null version
        ...
        Assertions.assertTrue(after.isEmpty(), "unversioned row with null operation (no purpose) must be deleted");
    }

    @Test
    void testUnversionedDeleteWithNullOperationAndPurposeDeletesCorrectRows()
            throws AttributeException, NotFoundException {
        UUID objectUuid = UUID.randomUUID();
        ...
        ObjectAttributeContentInfo info = ObjectAttributeContentInfo
                ...
                .connector(connector.getUuid())
                .purpose(purpose)
                .build(); // null operation, with purpose, null version
        ...
        var after = attributeEngine.getObjectDataAttributesContent(info);
        Assertions.assertTrue(after.isEmpty(), "unversioned row with null operation (with purpose) must be deleted");
    }
    ...
    void testUnversionedDeleteDoesNotAffectVersionedRows() throws AttributeException, NotFoundException {
        ...
        ObjectAttributeContentInfo unvInfo = ObjectAttributeContentInfo
                .builder(VERSIONED_RESOURCE, objectUuid)
                .connector(connector.getUuid())
                .build();
        ...
        Assertions.assertTrue(unvAfter.isEmpty(), "unversioned row must be deleted");

        // Versioned row must remain intact
        var v1After = attributeEngine.getObjectDataAttributesContent(v1Info);
        Assertions.assertEquals(1, v1After.size(), "versioned row (v1) must survive the unversioned delete");
        Assertions.assertEquals("v1", firstStringValue(v1After), "v1 value must be unchanged after unversioned delete");
    }
    ...
    void testReadingUnwrittenVersionReturnsEmptyList() throws AttributeException, NotFoundException {
        ...
        attributeEngine
                .updateObjectDataAttributesContent(ObjectAttributeContentInfo
                        ...
                        .operation(OPERATION_SIGN)
                        .version(1)
                        .build(), List.of(buildRequest(def, "v1_only")));
        ...
        var v2Content = attributeEngine
                .getObjectDataAttributesContent(ObjectAttributeContentInfo
                        ...
                        .build());
        Assertions
                .assertTrue(v2Content.isEmpty(), "Reading a version that was never written must return an empty list");
        ...
        var v1Content = attributeEngine
                .getObjectDataAttributesContent(ObjectAttributeContentInfo
                        ...
                        .version(1)
                        .build());
        Assertions.assertEquals(1, v1Content.size(), "v1 must be readable after checking that v2 returns empty");
    ...
    void testDeleteVersionedWithPurposeIsScoped() throws AttributeException, NotFoundException {
        ...
        attributeEngine
                .updateObjectDataAttributesContent(ObjectAttributeContentInfo
                        ...
                        .purpose(purpose)
                        .version(1)
                        .build(), List.of(buildRequest(def, "v1_purp_value")));
        attributeEngine
                .updateObjectDataAttributesContent(ObjectAttributeContentInfo
                        .builder(VERSIONED_RESOURCE, objectUuid)
                        .connector(connector.getUuid())
                        ...
                        .purpose(purpose)
                        .version(2)
                        .build(), List.of(buildRequest(def, "v2_purp_value")));
    ...
    void testDeduplicationIsScopedByPurpose() throws AttributeException, NotFoundException {
        ...
        attributeEngine
                .updateObjectDataAttributesContent(ObjectAttributeContentInfo
                        ...
                        .purpose(purposeA)
                        .version(1)
                        .build(), List.of(buildRequest(def, "shared_value")));
        attributeEngine
                .updateObjectDataAttributesContent(ObjectAttributeContentInfo
                        .builder(VERSIONED_RESOURCE, objectUuid)
                        .connector(connector.getUuid())
        ...
        Assertions
                .assertEquals(1, contentA.size(),
                        "purpose '" + purposeA + "' must have exactly one attribute after the fix");
        Assertions
                .assertEquals("shared_value", firstStringValue(contentA),
                        "purpose '" + purposeA + "' must return the correct value");

        Assertions
                .assertEquals(1, contentB.size(), "purpose '" + purposeB
                        + "' must have exactly one attribute — was silently dropped before the fix");
        Assertions
                .assertEquals("shared_value", firstStringValue(contentB),
                        "purpose '" + purposeB + "' must return the correct value");

        // Two distinct mapping rows must exist at the repository level (one per purpose, sharing the same
        // AttributeContentItem).
        var allRows = attributeContent2ObjectRepository
                .getAllObjectDataAttributesContent(VERSIONED_RESOURCE, objectUuid);
        Assertions.assertEquals(2, allRows.size(), "two separate mapping rows must exist — one per purpose");
    }
    ...
    void testNoVersionOverloadReturnsOnlyUnversionedRows() throws AttributeException, NotFoundException {
        ...
        attributeEngine
                .updateDataAttributeDefinitions(connector.getUuid(), OPERATION_SIGN,
                        List.of(unversionedDef, versionedDef));
        ...
        attributeEngine
                .updateObjectDataAttributesContent(ObjectAttributeContentInfo
                        ...
                        .connector(connector.getUuid())
                        .operation(OPERATION_SIGN)
                        .build(), List.of(buildRequest(unversionedDef, "unversioned_value")));
        ...
        attributeEngine
                .updateObjectDataAttributesContent(ObjectAttributeContentInfo
                        ...
                        .operation(OPERATION_SIGN)
                        .version(1)
                        .build(), List.of(buildRequest(versionedDef, "v1_value")));
        attributeEngine
                .updateObjectDataAttributesContent(ObjectAttributeContentInfo
                        .builder(VERSIONED_RESOURCE, objectUuid)
                        .connector(connector.getUuid())
                        .operation(OPERATION_SIGN)
                        .version(2)
                        .build(), List.of(buildRequest(versionedDef, "v2_value")));
        ...
        Assertions
                .assertEquals("unversioned_value", firstStringValue(result),
    ...
    /**
     * Verifies that metadata overwrite (properties.overwrite=true) is version-scoped: overwriting a meta attribute for
     * v1 must NOT delete v2's mapping for the same definition.
     */
    @Test
    void testMetadataOverwriteIsVersionScoped() throws AttributeException {
        ...
        List<String> v1Values = attributeEngine
                .getMappedMetadataContent(v1Info)
                .stream()
                .flatMap(dto -> dto.getItems().stream())
                .flatMap(item -> item.getContent().stream())
                .map(c -> c.getData().toString())
                .toList();
        Assertions
                .assertEquals(List.of("replaced_v1"), v1Values,
        ...
        List<String> v2Values = attributeEngine
                .getMappedMetadataContent(v2Info)
                .stream()
                .flatMap(dto -> dto.getItems().stream())
                .flatMap(item -> item.getContent().stream())
                .map(c -> c.getData().toString())
                .toList();
        Assertions
                .assertEquals(List.of("original_v2"), v2Values,
