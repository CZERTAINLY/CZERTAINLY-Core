...
class SecretsUtilTest {
    ...
    void testFingerprintCalculation() throws NoSuchAlgorithmException, JsonProcessingException {
        ...
        BasicAuthSecretContent basicAuthSecretContentWithExtraProperty = new BasicAuthSecretContent("testUsername",
                "testPassword");
        Assertions
                .assertEquals(SecretsUtil.calculateSecretContentFingerprint(basicAuthSecretContent),
                        SecretsUtil.calculateSecretContentFingerprint(basicAuthSecretContentWithExtraProperty));
        ...
        KeyValueSecretContent keyValueSecretContent3 = new KeyValueSecretContent(
                Map.of("key2", "value2", "key1", "value1"));
        Assertions
                .assertEquals(SecretsUtil.calculateSecretContentFingerprint(keyValueSecretContent1),
                        SecretsUtil.calculateSecretContentFingerprint(keyValueSecretContent2));
        Assertions
                .assertNotEquals(SecretsUtil.calculateSecretContentFingerprint(keyValueSecretContent1),
                        SecretsUtil.calculateSecretContentFingerprint(keyValueSecretContent3));

        KeyStoreSecretContent keyStoreSecretContent = new KeyStoreSecretContent(KeyStoreType.PKCS12, "content",
                "password");
        KeyStoreSecretContent keyStoreSecretContent2 = new KeyStoreSecretContent(KeyStoreType.PKCS12, "content",
                "password2");
        Assertions
                .assertEquals(SecretsUtil.calculateSecretContentFingerprint(keyStoreSecretContent),
                        SecretsUtil.calculateSecretContentFingerprint(keyStoreSecretContent2));
        ...
        Assertions
                .assertEquals(SecretsUtil.calculateSecretContentFingerprint(apiKeySecretContent),
                        SecretsUtil.calculateSecretContentFingerprint(apiKeySecretContent2));
        ...
        Assertions
                .assertEquals(SecretsUtil.calculateSecretContentFingerprint(privateKeySecretContent),
                        SecretsUtil.calculateSecretContentFingerprint(privateKeySecretContent2));
        ...
        Assertions
                .assertEquals(SecretsUtil.calculateSecretContentFingerprint(secretKeySecretContent),
                        SecretsUtil.calculateSecretContentFingerprint(secretKeySecretContent2));
        ...
        Assertions
                .assertEquals(SecretsUtil.calculateSecretContentFingerprint(jwtTokenSecretContent),
                        SecretsUtil.calculateSecretContentFingerprint(jwtTokenSecretContent2));
        ...
        Assertions
                .assertEquals(SecretsUtil.calculateSecretContentFingerprint(genericSecretContent),
                        SecretsUtil.calculateSecretContentFingerprint(genericSecretContent2));
