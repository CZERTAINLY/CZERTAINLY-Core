...
class CallbackServiceTest extends BaseSpringBootTest {
    ...
    void testCallback() throws ConnectorException, NotFoundException {
        ...
        GroupAttributeV2 groupAttributeV3 = new GroupAttributeV2();
        ...
        mockServer.stubFor(WireMock.get(WireMock.urlPathMatching("/v1/[^/]+/[^/]+/attributes")).willReturn(WireMock.okJson(AttributeDefinitionUtils.serialize(List.of(groupAttributeV3)))));
