...
class ScepServiceTest extends BaseSpringBootTest {
    ...
    void testScepProfileValidity() {
        ...
        scepProfileRepository.save(tempProfile);
        Assertions.assertThrows(ScepException.class, () -> scepService.handlePost(scepProfile.getName(), ScepServiceImpl.SCEP_OPERATION_GET_CA_CERT, null), "SCEP profile should have CA certificate");
        ...
        scepProfileRepository.save(tempProfile);
        Assertions.assertThrows(ScepException.class, () -> scepService.handlePost(scepProfile.getName(), ScepServiceImpl.SCEP_OPERATION_GET_CA_CERT, null), "SCEP profile should have eligible CA certificate");

        tempProfile.setCaCertificate(certificate);
        scepProfileRepository.save(tempProfile);
        Assertions.assertThrows(ScepException.class, () -> scepService.handlePost(scepProfile.getName(), ScepServiceImpl.SCEP_OPERATION_GET_CA_CERT, null), "SCEP profile should have RA profile");

        tempProfile.setRaProfile(raProfile);
        scepProfileRepository.save(tempProfile);
        Assertions.assertThrows(ScepException.class, () -> scepService.handlePost(scepProfile.getName(), ScepServiceImpl.SCEP_OPERATION_GET_CA_CERT, null), "SCEP profile should have enabled RA profile");
    ...
    void testScepService() {
        ...
        Assertions.assertDoesNotThrow(() -> scepService.handlePost(scepProfile.getName(), ScepServiceImpl.SCEP_OPERATION_GET_CA_CERT, null));
        Assertions.assertDoesNotThrow(() -> scepService.handlePost(scepProfile.getName(), ScepServiceImpl.SCEP_OPERATION_GET_CA_CAPS, null));
