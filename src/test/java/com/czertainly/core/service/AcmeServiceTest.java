...
public class AcmeServiceTest extends BaseSpringBootTest {
    ...
    public void testGetDirectory() throws AcmeProblemDocumentException, NotFoundException {
        ResponseEntity<Directory> directory = acmeService.getDirectory("sameName", false);
    ...
    public void testNewAccount() throws AcmeProblemDocumentException, NotFoundException, URISyntaxException {
        ...
        ResponseEntity<Account> account = acmeService.newAccount("sameName", requestJson, requestUri, false);
    ...
    public void testNewAccount_Fail() throws AcmeProblemDocumentException, NotFoundException {
        String requestJson = "{\n" +
                ...
                "}";
        Assertions.assertThrows(AcmeProblemDocumentException.class, () -> acmeService.newAccount("sameName", requestJson, new URI("http://localhost"), false));
    }
    ...
    public void testNewOrder() throws AcmeProblemDocumentException, NotFoundException {
        ...
        try {
            ...
            ResponseEntity<Order> order = acmeService.newOrder("sameName", requestJson, requestUri, false);
    ...
    public void testNewOrder_Fail() throws AcmeProblemDocumentException, NotFoundException {
        String requestJson = "{\n" +
                ...
                "  \"payload\": \"dfgdrtyufghgjghktyfghdtu\"\n" +
                "}";
        Assertions.assertThrows(AcmeProblemDocumentException.class, () -> acmeService.newOrder("sameName", requestJson, new URI("http://localhost"), false));
    }
    ...
    public void testGetAuthorization() throws AcmeProblemDocumentException, NotFoundException, URISyntaxException {
        ...
        ResponseEntity<Authorization> authorization = acmeService.getAuthorization("sameName", "auth123", requestJson, requestUri, false);
    ...
    public void testFinalize() throws AcmeProblemDocumentException, ConnectorException, CertificateException, AlreadyExistException, JsonProcessingException, URISyntaxException {
        ...
        Assertions.assertThrows(AcmeProblemDocumentException.class, () -> acmeService.finalizeOrder("sameName", "order123", requestJson, requestUri, false));
    }
    ...
    public void testRevokeCert() throws AcmeProblemDocumentException, ConnectorException, CertificateException, URISyntaxException {
        ...
        Assertions.assertThrows(NullPointerException.class, () -> acmeService.revokeCertificate("sameName", requestJson, requestUri, false));
