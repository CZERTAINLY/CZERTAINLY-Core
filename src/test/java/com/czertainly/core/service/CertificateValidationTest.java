...
public class CertificateValidationTest extends BaseSpringBootTest {
    ...
    void testVerifyAlt() throws IOException, NoSuchAlgorithmException, InvalidKeySpecException, InvalidKeyException, SignatureException, CertificateEncodingException {
        ...
        X509Certificate certificate = CertificateUtil.parseUploadedCertificateContent(certificateString);
        ...
        byte[] altCertificateSignature = CertificateUtil.getAltSignatureValue(certificate.getExtensionValue(Extension.altSignatureValue.getId()));
        Signature signature = Signature.getInstance(CertificateUtil.getAlternativeSignatureAlgorithm(certificate.getExtensionValue(Extension.altSignatureAlgorithm.getId())));
