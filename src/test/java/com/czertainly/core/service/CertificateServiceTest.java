...
public class CertificateServiceTest extends BaseSpringBootTest {
    ...
    public void testDownloadCertificate() throws NotFoundException, CertificateException, IOException {
        CertificateDownloadResponseDto certificateDownloadResponseDto;
        ...
        certificateDownloadResponseDto = certificateService.downloadCertificate(certificate.getUuid().toString(), CertificateFormat.RAW, CertificateFormatEncoding.PEM);
        CertificateDownloadResponseDto finalCertificateDownloadResponseDto1 = certificateDownloadResponseDto;
        Assertions.assertDoesNotThrow(() -> (certificateService.createCertificate(finalCertificateDownloadResponseDto1.getContent(), CertificateType.X509)));
        certificateDownloadResponseDto = certificateService.downloadCertificate(certificate.getUuid().toString(), CertificateFormat.RAW, CertificateFormatEncoding.DER);
        CertificateDownloadResponseDto finalCertificateDownloadResponseDto = certificateDownloadResponseDto;
        Assertions.assertDoesNotThrow(() -> (certificateService.createCertificate(finalCertificateDownloadResponseDto.getContent(), CertificateType.X509)));
        certificateDownloadResponseDto = certificateService.downloadCertificate(certificate.getUuid().toString(), CertificateFormat.PKCS7, CertificateFormatEncoding.PEM);
        CertificateDownloadResponseDto finalCertificateDownloadResponseDto3 = certificateDownloadResponseDto;
        Assertions.assertDoesNotThrow(() -> (certificateService.createCertificate(finalCertificateDownloadResponseDto3.getContent(), CertificateType.X509)));
        certificateDownloadResponseDto = certificateService.downloadCertificate(certificate.getUuid().toString(), CertificateFormat.PKCS7, CertificateFormatEncoding.DER);
        Assertions.assertDoesNotThrow(() -> (certificateService.createCertificate(finalCertificateDownloadResponseDto.getContent(), CertificateType.X509)));
        CertificateDownloadResponseDto finalCertificateDownloadResponseDto4 = certificateDownloadResponseDto;
        Assertions.assertDoesNotThrow(() -> (certificateService.createCertificate(finalCertificateDownloadResponseDto4.getContent(), CertificateType.X509)));
