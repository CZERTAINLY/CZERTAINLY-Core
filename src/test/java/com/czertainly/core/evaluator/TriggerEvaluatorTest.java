...
class TriggerEvaluatorTest extends BaseSpringBootTest {
    ...
    void testCertificateEvaluatorOnEnumListBitmask() throws RuleException {
        certificate.setKeyUsage(BitMaskEnum.convertListToBitMask(Set.of(CertificateKeyUsage.DIGITAL_SIGNATURE, CertificateKeyUsage.KEY_ENCIPHERMENT, CertificateKeyUsage.KEY_AGREEMENT)));
        condition.setFieldSource(FilterFieldSource.PROPERTY);
